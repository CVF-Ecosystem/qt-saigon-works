...
> CVF Commit: dc841d33
> Bootstrap Date: 2026-05-04
> Project: qt-saigon-works
...
## Project UI/UX Responsive Rule

Before creating or changing UI in this project, read:

1. `docs/AGENT_HANDOFF.md`
2. `docs/UI_UX_MOBILE_DESKTOP_STANDARDS.md`
3. `D:\UNG DUNG AI\TOOL AI 2026\CVF-Workspace\.Controlled-Vibe-Framework-CVF\DESIGN.md`

Mobile and desktop must be designed together from the first pass. Do not treat
mobile support as a post-build patch. For material UI changes, verify at least
375px, 390px, 768px, 1366px, and 1440px viewports before declaring completion.
